...
const BidItemStepElectric = ({
  ...
  const handleLoadMore = () => {
    if (!isMoreLoading && page < totalPagesItem) {
      ...
      dispatch(getBidElectricItem(nextPage, search))
        .then(response => {
